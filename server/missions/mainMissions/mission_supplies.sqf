...
_result = 0;
_veh = ["UralCivil","UralCivil2"] call BIS_fnc_selectRandom;
...
_vehicle setVariable["water",round(random 400),true];
_name = "Water supply truck";
};
if(_veh == "UralCivil2") then {
_vehicle setVariable["food",round(random 400),true];
