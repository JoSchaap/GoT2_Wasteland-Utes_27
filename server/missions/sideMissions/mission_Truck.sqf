...
private ["_playerPresent","_missionType","_successTextColour","_mainTextColour","_failTextColour","_subTextColour","_picture","_vehicleName","_rad","_centerPos","_missionTimeOut","_missionDelayTime","_missionTriggerRadius","_missionPlayerRadius","_flatareas","_randomArea","_hint","_startTime","_currTime","_result","_truck","_randomIndex","_selectedMarker","_indexAmount","_GotLoc","_WhyDoINeedThis","_randomPos"];
